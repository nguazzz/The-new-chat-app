...
const SignUp: FC = () => {
  ...
  return (
    ...
    //     <form onSubmit={requestOTP}>
    //       <div className="mb-3">
    //         <label className="form-label  text-lighten font-medium">
    //           Username
    //         </label>
    //         <input
    //           type="tel"
    ...
    //         <label
    //           htmlFor="phoneNumberInput"
    //           className="form-label  text-lighten font-medium"
    //         >
    //           PhoneNumber
    //         </label>
    //         <input
    ...
    //       <button
    //         disabled={registering}
    //         className="form-control border-lighten bg-light text-dark-lighten"
    //         type="submit"
    //       >
    //         Sign Up
    //       </button>
    ...
    //           <label
    //             htmlFor="otpInput"
    //             className="form-label text-lighten mr-3 font-medium "
    //           >
    //             OTP :
    //           </label>
    //           <input
